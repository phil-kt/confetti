      ...
      <div className="Home container">
        <div className="intro row">
          ...
          <div className="col-lg-6">
            <p>
              A user experience designer passionate about making technology delightful, intuitive, and accessible to everyone. (Especially in the realm of emoji, virtual reality, and augmented reality). Currently I'm wrapping up my Master's degree at Georgia Tech's HCI program and studyi
            </p>
            <p>
